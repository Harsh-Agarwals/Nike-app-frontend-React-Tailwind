...
import { offer } from "../assets - Copy/images";
import Button from "../components/Button";

export default function SpecialOffer() {
    return (
        <section className="flex flex-col md:flex-row justify-between items-center gap-10 max-container max-xl:flex-col-reserve">
